                ...
                else
                {
                    ...
                    if (Ray_.Kz[j] < 0)
                    {
                        ...
                        {   // HACK: закрив очі на ситуацію коли промінь рухається в прошарку = R
                            ...
                            EndAngl = Math.Asin(dummy / R) * 180 / Math.PI; j--;                // водний прошарок зміщується на крок вверх
                        }
                ...
                else
                {
                    ...
                    if (Ray_.Kz[j] < 0)
                    {
                        ...
                        if (dummy < R)
                        {
                            ...
                            EndAngl = 270 + Math.Asin(dummy / R) * 180 / Math.PI; j++;          // водний прошарок зміщується на крок вниз
                        }
                    ...
                    else
                    {
                        ...
                        {   // HACK: закрив очі на ситуацію коли кінцевий кут буде дорівнювати 90
                            BgnA -= 1 * Math.PI / 2;                                            // промінь по дузі пішов вверх
